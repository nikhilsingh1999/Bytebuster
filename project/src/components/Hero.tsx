...
export const Hero = () => {
  return (
    <section className="min-h-screen pt-32 pb-16 bg-[#0B1120] relative overflow-hidden" id="home">
      {/* Floating Elements */}
      <motion.div 
        className="absolute top-1/4 left-10 w-20 h-20 bg-[#FF00FF]/20 rounded-full blur-xl"
        animate={{ y: [-20, 20], x: [-10, 10] }}
        transition={{ repeat: Infinity, duration: 5, repeatType: "reverse" }}
      />
      <motion.div 
        className="absolute bottom-1/4 right-10 w-20 h-20 bg-[#00FFFF]/20 rounded-full blur-xl"
        animate={{ y: [20, -20], x: [10, -10] }}
      ...
      <div className="container mx-auto grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <motion.button
            className="px-8 py-4 rounded-full bg-[#FF00FF] text-white font-medium text-lg shadow-lg hover:shadow-[#FF00FF]/50"
        ...
        >
          ...
          <motion.div
            className="absolute -bottom-10 -left-10 p-6 rounded-xl bg-[#151C31]/80 backdrop-blur-sm shadow-xl"
            animate={{ x: [-20, 200] }}
            transition={{ repeat: Infinity, duration: 4, repeatType: "reverse" }}
          >
          ...
          <motion.div
            className="absolute -top-10 -right-10 p-6 rounded-xl bg-[#151C31]/80 backdrop-blur-sm shadow-xl"
            animate={{ y: [200, -20] }}
            transition={{ repeat: Infinity, duration: 4, repeatType: "reverse" }}
          >
            <div className="flex items-center space-x-4">
